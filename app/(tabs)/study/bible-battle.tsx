...
export default function BibleBattleScreen() {
  ...
  useEffect(() => {
    if (timerActive) {
      timerWidth.setValue(timeLeft / TIME_LIMIT);
    }
  }, [timeLeft, timerActive, timerWidth]);
  ...
  }, [currentIndex, shuffledQuestions.length, fadeAnim, resultScale, isDuo, duoTurn, score, p1Score, p2Score, addGameResult, state.quizHighScore, timerWidth, turnModalScale]);
