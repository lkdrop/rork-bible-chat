    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.dayContent}>
          ...
          <View style={[styles.verseCard, { backgroundColor: '#C9922A' + '10', borderColor: '#C9922A' + '30' }]}>
        ...
        {vigiliaDays.map((vd) => {
          ...
          return (
            ...
            >
              ...
              {locked && (
                <View style={[styles.premiumBadge, { backgroundColor: '#C9922A' + '15' }]}>
...
const styles = StyleSheet.create({
  ...
  premiumBadgeText: { fontSize: 10, fontWeight: '700' as const, color: '#C9922A' },
  ...
  verseAccent: { width: 4, backgroundColor: '#C9922A' },
  verseInner: { flex: 1, padding: 16 },
  verseText: { fontSize: 16, lineHeight: 26, fontStyle: 'italic' as const },
  verseRef: { fontSize: 14, fontWeight: '700' as const, color: '#C9922A', marginTop: 8 },
