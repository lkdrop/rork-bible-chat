...
const initialMessages: ChatMessage[] = [
  { id: 'm1', userName: 'Pastor Ricardo', avatar: '📖', level: 12, levelTitle: 'Embaixador', levelColor: '#C9922A', content: 'Boa noite, família! Que a paz do Senhor esteja com todos vocês 🙏', time: '21:30', isMe: false },
  ...
  { id: 'm7', userName: 'Pastor Ricardo', avatar: '📖', level: 12, levelTitle: 'Embaixador', levelColor: '#C9922A', content: 'Vamos orar juntos agora: Pai, nós te entregamos a mãe da Ana. Tu que és o Deus que cura, opera milagres e sustenta. Em nome de Jesus, amém! 🙏', time: '21:34', isMe: false },
  ...
  { id: 'm10', userName: 'Marcos A.', avatar: '⭐', level: 11, levelTitle: 'Guerreiro', levelColor: '#C9922A', content: 'Alguém mais quer compartilhar algo? Este é um espaço seguro para todos nós 🕊️', time: '21:36', isMe: false },
];
