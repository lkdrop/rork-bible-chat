...
export const LEVELS: Level[] = [
  ...
  { level: 5, title: 'Servo', emoji: '🙏', minXP: 500, color: '#C5943A' },
  ...
  { level: 11, title: 'Guerreiro da Fé', emoji: '⚔️', minXP: 5000, color: '#C5943A' },
  { level: 12, title: 'Embaixador de Cristo', emoji: '👑', minXP: 7000, color: '#8B6914' },
];
